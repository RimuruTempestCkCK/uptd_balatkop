...
$stmtPeserta->execute();
$peserta = $stmtPeserta->get_result()->fetch_assoc();
...
if ($peserta) {
    ...
    /* =======================
       PELATIHAN + JADWAL YANG DIIKUTI PESERTA
    ======================= */
    $stmt = $conn->prepare("
        SELECT
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                ...
                <div class="page-header">
                    <h1><i class="fas fa-calendar-alt"></i> Jadwal Pelatihan Saya</h1>
                    <p class="text-muted">Pelatihan yang sedang Anda ikuti</p>
                </div>

                <?php if (empty($pelatihanData)): ?>
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i>
                        Anda belum terdaftar pada pelatihan apa pun
                    </div>
                <?php else: ?>
